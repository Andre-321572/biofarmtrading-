...
<body class="bg-gray-50 text-gray-900 antialiased h-screen overflow-hidden flex flex-col">
            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex-shrink-0 flex items-center">
                        <img src="{{ asset('images/joossi_kinu_final.png') }}" alt="Joossi x Kinu Logo" class="h-16 sm:h-20 w-auto object-contain">
                    </a>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div class="col-span-1 md:col-span-2">
                            <div class="flex items-center mb-4">
                                <img src="{{ asset('images/joossi_kinu_final.png') }}" alt="Joossi x Kinu Logo" class="h-16 w-auto">
                            </div>
    ...
    <div class="sm:hidden fixed bottom-0 left-0 right-0 z-[100] bg-white border-t border-gray-100 px-4 py-2 pb-safe flex justify-between items-center shadow-[0_-4px_20px_rgba(0,0,0,0.08)]" style="padding-bottom: env(safe-area-inset-bottom, 1rem);">
        ...
        <button id="install-pwa" style="display: none;" class="flex flex-col items-center p-2 text-green-600 transform active:scale-95 transition-transform">
             <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
             </svg>
             <span class="text-[10px] font-bold mt-1">Installer</span>
        </button>
