...
@section('content')
<div class="py-5" x-data="productionForm()">
    <div class="max-w-[1750px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 bg-white p-5 rounded-lg border border-gray-200 shadow-xs">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-emerald-600 text-white rounded-lg flex items-center justify-center shadow-sm">
                    <i class="fa-solid fa-file-circle-plus text-xl"></i>
                </div>
                <div>
                    <h1 class="text-lg font-black text-gray-900 tracking-tight">
                        Nouveau Rapport Journalier de Production
                    </h1>
                    <p class="text-xs text-gray-500">
                        Saisie atelier des effectifs, inventaire matériel (couteaux, ciseaux), poids de coupes (kg) et sachets.
                    </p>
                </div>
            </div>
            <a href="{{ route('rp.production-reports.index') }}" class="px-4 py-2 bg-slate-100 text-slate-700 font-bold text-xs rounded-lg hover:bg-slate-200 transition-colors flex items-center gap-2 self-start sm:self-auto">
        ...
        <form action="{{ route('rp.production-reports.store') }}" method="POST">
            @csrf
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200 shadow-xs mb-4 space-y-4">
                ...
                <!-- Block 1: Date & Effectifs Ouvriers -->
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="bg-slate-50 p-2 rounded-md border border-slate-200">
                            ...
                            <input type="date" name="date_rapport" value="{{ old('date_rapport', date('Y-m-d')) }}" required
                                   class="w-full h-8 py-1 px-2 rounded-md border-gray-300 text-xs font-bold text-gray-900 focus:border-emerald-500 focus:ring-emerald-500 bg-white">
                        </div>
                        ...
                        <div class="bg-emerald-50/70 p-2 rounded-md border border-emerald-200">
                            ...
                            <div class="relative">
                                <input type="number" name="nombre_ouvriers" value="{{ old('nombre_ouvriers', 0) }}" min="0" required
                                       class="w-full h-8 py-1 pl-7 pr-2 rounded-md border-emerald-300 text-xs font-black text-emerald-800 focus:border-emerald-500 focus:ring-emerald-500 bg-white">
                        ...
                        <div class="bg-rose-50/70 p-2 rounded-md border border-rose-200">
                            ...
                            <div class="relative">
                                <input type="number" name="nombre_ouvriers_absents" value="{{ old('nombre_ouvriers_absents', 0) }}" min="0"
                                       class="w-full h-8 py-1 pl-7 pr-2 rounded-md border-rose-300 text-xs font-black text-rose-800 focus:border-rose-500 focus:ring-rose-500 bg-white">
                        ...
                        <div class="bg-amber-50/70 p-2 rounded-md border border-amber-200">
                            ...
                            <div class="relative">
                                <input type="number" name="nombre_ouvriers_repos" value="{{ old('nombre_ouvriers_repos', 0) }}" min="0"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="bg-slate-50 p-2 rounded-md border border-slate-200">
                            ...
                            <div class="relative">
                                <input type="number" name="nombre_couteaux_debut" value="{{ old('nombre_couteaux_debut', 0) }}" min="0"
                                       class="w-full h-8 py-1 pl-7 pr-2 rounded-md border-gray-300 text-xs font-bold text-slate-900 focus:border-teal-500 focus:ring-teal-500 bg-white">
                        ...
                        <div class="bg-slate-50 p-2 rounded-md border border-slate-200">
                            ...
                            <div class="relative">
                                <input type="number" name="nombre_couteaux_fin" value="{{ old('nombre_couteaux_fin', 0) }}" min="0"
                                       class="w-full h-8 py-1 pl-7 pr-2 rounded-md border-gray-300 text-xs font-bold text-slate-900 focus:border-teal-500 focus:ring-teal-500 bg-white">
                                <i class="fa-solid fa-kitchen-set absolute left-2 top-2 text-slate-500 text-[11px]"></i>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-50 p-2 rounded-md border border-slate-200">
                            ...
                            <div class="relative">
                                <input type="number" name="nombre_ciseaux_debut" value="{{ old('nombre_ciseaux_debut', 0) }}" min="0"
                                       class="w-full h-8 py-1 pl-7 pr-2 rounded-md border-gray-300 text-xs font-bold text-slate-900 focus:border-teal-500 focus:ring-teal-500 bg-white">
                        ...
                        <div class="bg-slate-50 p-2 rounded-md border border-slate-200">
                            ...
                            <div class="relative">
                                <input type="number" name="nombre_ciseaux_fin" value="{{ old('nombre_ciseaux_fin', 0) }}" min="0"
                                       class="w-full h-8 py-1 pl-7 pr-2 rounded-md border-gray-300 text-xs font-bold text-slate-900 focus:border-teal-500 focus:ring-teal-500 bg-white">
                                <i class="fa-solid fa-scissors absolute left-2 top-2 text-slate-500 text-[11px]"></i>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
                    <div>
                        ...
                        <input type="text" name="lots_peles" value="{{ old('lots_peles') }}" placeholder="Ex: Pelage du Lot 287/ANAS/2026 et 007/PAP/2026"
                               class="w-full h-8 py-1 px-2.5 rounded-md border-gray-300 text-xs font-medium focus:border-emerald-500 focus:ring-emerald-500 bg-slate-50">
                    </div>

                    <div>
                        <label class="block text-[10px] font-bold text-gray-700 uppercase tracking-wider mb-0.5">Observations / Notes Générales</label>
                        <input type="text" name="notes" value="{{ old('notes') }}" placeholder="Remarques éventuelles sur la journée de travail..."
                               class="w-full h-8 py-1 px-2.5 rounded-md border-gray-300 text-xs font-medium focus:border-emerald-500 focus:ring-emerald-500 bg-slate-50">
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-xs mb-5">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 pb-3 border-b border-gray-200 gap-2">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-gray-500">Saisissez les poids déclayés, poids par coupe (kg) et sachets par format.</p>
                        </div>
                    </div>
                    <button type="button" @click="addLot()" class="px-4 py-2 bg-emerald-600 text-white rounded-lg text-xs font-bold hover:bg-emerald-700 shadow-sm transition-colors flex items-center gap-1.5 self-start sm:self-auto">
                        <i class="fa-solid fa-plus text-xs"></i> Ajouter un Lot
                    </button>
                </div>

                <!-- Légende Abréviations Claire -->
                <div class="bg-emerald-50/80 border border-emerald-200 text-emerald-950 rounded-lg p-3 mb-4 text-xs font-medium flex flex-wrap items-center gap-x-6 gap-y-1.5">
                    <span class="font-black text-emerald-800 uppercase tracking-wider text-[11px] flex items-center gap-1">
                        <i class="fa-solid fa-bookmark text-emerald-600"></i> Légende des Coupes Bio Farm :
                    </span>
                            ...
                            <template x-for="(lot, index) in lots" :key="index">
                                <tr class="hover:bg-slate-50/70 transition-colors">
                                    ...
                                    <td class="p-3 align-middle">
                                        <input type="text" :name="'lots['+index+'][numero_lot]'" x-model="lot.numero_lot" required placeholder="ex: Lot 285/ANA"
                                               class="w-full py-1.5 px-2.5 rounded-md border-gray-300 text-xs font-bold focus:border-emerald-500 focus:ring-emerald-500 bg-white">
                                    </td>

                                    <!-- Type Produit -->
                                    <td class="p-3 align-middle">
                                        <select :name="'lots['+index+'][type_produit]'" x-model="lot.type_produit" @change="onFruitChange(index)"
                                                class="w-full py-1.5 px-2 rounded-md border-gray-300 text-xs font-bold text-emerald-800 bg-emerald-50/50 focus:border-emerald-500 focus:ring-emerald-500">
                                    ...
                                    <!-- Qté Déclayée kg -->
                                    <td class="p-3 align-middle">
                                        <input type="number" step="0.01" min="0" :name="'lots['+index+'][quantite_declayee_kg]'" x-model="lot.quantite_declayee_kg" placeholder="0.00"
                                               class="w-full py-1.5 px-2 rounded-md border-gray-300 text-xs font-bold text-right text-gray-900 focus:border-emerald-500 focus:ring-emerald-500 bg-white">
                                    </td>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div class="flex items-center gap-2 bg-white p-2 rounded-md border border-emerald-200">
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <input type="number" step="0.01" min="0" :name="'lots['+index+'][poids_rcl_kg]'" x-model="lot.poids_rcl_kg" placeholder="0.00" class="w-20 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold text-emerald-700 focus:ring-emerald-500">
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_rcl_2kg]'" x-model="lot.sachets_rcl_2kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">1kg:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_rcl_1kg]'" x-model="lot.sachets_rcl_1kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center gap-2 bg-white p-2 rounded-md border border-blue-200">
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">Poids:</span>
                                                        <input type="number" step="0.01" min="0" :name="'lots['+index+'][poids_mcl_kg]'" x-model="lot.poids_mcl_kg" placeholder="0.00" class="w-20 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold text-blue-700 focus:ring-emerald-500">
                                                        <span class="text-[10px] text-gray-400 font-bold">kg</span>
                                                    </div>
                                                    <div class="h-4 w-px bg-gray-200 mx-0.5"></div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">2kg:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_mcl_2kg]'" x-model="lot.sachets_mcl_2kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">1kg:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_mcl_1kg]'" x-model="lot.sachets_mcl_1kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center gap-2 bg-white p-2 rounded-md border border-slate-200">
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <input type="number" step="0.01" min="0" :name="'lots['+index+'][cl_ttpm_kg]'" x-model="lot.cl_ttpm_kg" placeholder="0.00" class="w-20 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold text-slate-800 focus:ring-emerald-500">
                                                        <span class="text-[10px] text-gray-400 font-bold">kg</span>
                                                    </div>
                                                    <div class="h-4 w-px bg-gray-200 mx-0.5"></div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-700">Sachets 1KG:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_ttpm_1kg]'" x-model="lot.sachets_ttpm_1kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                        ...
                                        <template x-if="lot.type_produit === 'Ananas Pain de Sucre'">
                                            <div class="space-y-2">
                                                ...
                                                <div class="flex items-center gap-2 bg-white p-2 rounded-md border border-amber-200">
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">Poids:</span>
                                                        <input type="number" step="0.01" min="0" :name="'lots['+index+'][poids_rps_kg]'" x-model="lot.poids_rps_kg" placeholder="0.00" class="w-20 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold text-amber-700 focus:ring-emerald-500">
                                                        <span class="text-[10px] text-gray-400 font-bold">kg</span>
                                                    </div>
                                                    <div class="h-4 w-px bg-gray-200 mx-0.5"></div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">2kg:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_rps_2kg]'" x-model="lot.sachets_rps_2kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">1kg:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_rps_1kg]'" x-model="lot.sachets_rps_1kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center gap-2 bg-white p-2 rounded-md border border-amber-300">
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">Poids:</span>
                                                        <input type="number" step="0.01" min="0" :name="'lots['+index+'][poids_mps_kg]'" x-model="lot.poids_mps_kg" placeholder="0.00" class="w-20 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold text-amber-800 focus:ring-emerald-500">
                                                        <span class="text-[10px] text-gray-400 font-bold">kg</span>
                                                    </div>
                                                    <div class="h-4 w-px bg-gray-200 mx-0.5"></div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">2kg:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_mps_2kg]'" x-model="lot.sachets_mps_2kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                    <div class="flex items-center gap-1">
                                                        <span class="text-[11px] font-bold text-gray-500">1kg:</span>
                                                        <input type="number" min="0" :name="'lots['+index+'][sachets_mps_1kg]'" x-model="lot.sachets_mps_1kg" placeholder="0" class="w-14 py-1 px-2 rounded border-gray-300 text-xs text-right font-bold focus:ring-emerald-500">
                                                    </div>
                                                </div>
                                    ...
                                    <td class="p-3 align-middle">
                                        <input type="number" step="0.01" min="0" :name="'lots['+index+'][dechets_kg]'" x-model="lot.dechets_kg" placeholder="0.00"
                                               class="w-full py-1.5 px-2 rounded-md border-gray-300 text-xs text-right text-rose-600 font-bold focus:border-emerald-500 focus:ring-emerald-500 bg-white">
                                    </td>
                                    ...
                                    <td class="p-3 align-middle">
                                        <input type="number" step="0.01" min="0" x-model="lot.cl_ttpm_kg" placeholder="0.00"
                                               ...
                                               class="w-full py-1.5 px-2 rounded-md border-gray-300 text-xs text-right text-teal-700 font-bold focus:border-emerald-500 focus:ring-emerald-500 bg-white disabled:bg-gray-100 disabled:text-gray-400">
                                    </td>
                ...
                <div class="mt-4 flex justify-start">
                    <button type="button" @click="addLot()" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-xs font-bold transition-colors flex items-center gap-1.5">
                        <i class="fa-solid fa-plus-circle text-emerald-600"></i> Ajouter une ligne de lot
                    </button>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('rp.production-reports.index') }}" class="px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 font-bold text-xs hover:bg-gray-50 transition-colors">
                    Annuler
                </a>
                <button type="submit" class="px-6 py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs shadow-md transition-all flex items-center gap-2">
                    <i class="fa-solid fa-check"></i> Enregistrer & Générer le Rapport
                </button>
            </div>
        </form>
...
function productionForm() {
    return {
        lots: [
            { 
                numero_lot: 'Lot 285/ANA', 
                type_produit: 'Ananas Cayenne Lisse', 
                quantite_declayee_kg: 156.3, 
                ...
                sachets_mcl_2kg: 134, sachets_mcl_1kg: 0,
                ...
                sachets_ttpm_1kg: 0,
                dechets_kg: 35.65, cl_ttpm_kg: 6.5
            },
            { 
                numero_lot: 'Lot 286/ANA', 
                type_produit: 'Ananas Cayenne Lisse', 
                quantite_declayee_kg: 326.7, 
                poids_rcl_kg: 0, poids_mcl_kg: 0, poids_rps_kg: 0, poids_mps_kg: 0, poids_lpa_kg: 0,
                sachets_2kg: 0, sachets_1kg: 0, sachets_500g: 0,
                sachets_rcl_2kg: 0, sachets_rcl_1kg: 0,
                sachets_mcl_2kg: 48, sachets_mcl_1kg: 2,
                sachets_rps_2kg: 0, sachets_rps_1kg: 0,
                sachets_mps_2kg: 0, sachets_mps_1kg: 0,
                sachets_lpa_2kg: 0, sachets_lpa_1kg: 0, sachets_lpa_100g: 0,
                sachets_ttpm_1kg: 0,
                dechets_kg: 20, cl_ttpm_kg: 0
            }
        ],
        addLot() {
            this.lots.push({
