...
<div x-data="{ open: false }" class="z-50">
    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-7 scrollbar-hide">
            ...
            <div>
                <p class="px-2 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Responsable Production</p>
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('rp.dashboard') }}" 
                           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold {{ request()->routeIs('rp.dashboard') ? 'bg-green-50 text-green-700' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
                    ...
                    <li>
                        <a href="{{ route('rp.production-reports.index') }}" 
                           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold {{ request()->routeIs('rp.production-reports.*') ? 'bg-green-50 text-green-700' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
