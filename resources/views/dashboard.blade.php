        ...
        <div class="space-y-8">
            ...
            <div class="bg-gradient-to-br from-green-600 to-green-400 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
                <div class="relative z-10">
                    ...
                    @elseif(Auth::user()->role === 'achat_cooperative')
                        <a href="{{ route('purchase_invoices.index') }}" class="inline-flex items-center px-6 py-3 bg-white text-green-700 font-bold rounded-xl hover:bg-green-50 transition-colors shadow-lg">
